                ...
                <div>
                    {isInGuidedMode ? (
                        <div style={{
                            ...
                            <p style={{fontSize: "1.5vh"}}>Die für dich ausgewählten Stationen befinden sich alle auf
                                der Max-Joseph-Straße. Wie dir vielleicht bereits aufgefallen ist, nimmt die Temperatur
                                von Station zu Station ab, umso weiter wir uns von der alten Feuerwache entfernen. Der
                                Temperaturunterschied zu diesem Zeitpunkt zwischen der ersten und letzten Station auf
                                dieser Straße beträgt ganze 5 Grad. </p>
                            <p style={{fontSize: "1.5vh"}}>Außerdem interessant ist, dass wir uns im Verlauf der
                            ...
                            <p style={{fontSize: "1.5vh"}}>Erkunde gerne noch weiter die ausgewählten Messstationen und
