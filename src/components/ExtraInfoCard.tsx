    ...
    return (
        <div>
            ...
            {selectedStation ? (
                ...
                <div>
                    {isInGuidedMode ? (
                        <div style={{ border: "1px solid", height: "16rem", borderRadius: "0.5rem", width: "45rem", padding:"10px" }}>
                            <h4 style={{ margin: "0" }}>Willkommen im Guide-Modus!</h4>
                            <p>
                                Die für dich ausgewählten Stationen befinden sich alle auf der Max-Joseph-Straße. Wie dir vielleicht bereits aufgefallen ist, nimmt die Temperatur von Station zu Station ab, umso weiter wir uns von der alten Feuerwache entfernen. Der Temperaturunterschied zu diesem Zeitpunkt zwischen der ersten und letzten Station auf dieser Straße beträgt ganze XY Grad. Außerdem interessant ist, dass wir uns im Verlauf der Max-Joseph-Straße immer weiter dem Herzogenriedpark annähern. Dieser Park stellt mit seiner überdurchschnittlich hohen Begrünung und sehr geringen Versiegelung eine natürliche Abkühlungszone dar, die sich positiv auf ihre Umgebung auswirkt.
                            </p>
                        ...
                        <div style={{ border: "1px solid", height: "16rem", borderRadius: "0.5rem", width: "25rem", padding:"10px" }}>
                ...
                <div style={{ border: "1px solid", height: "16rem", borderRadius: "0.5rem", width: "25rem", padding:"10px" }}>
                    <p style={{ margin: "0" }}>Dieses Dashboard zeigt Temperaturwerte der Messstationen in der Neckarstadt.</p>
